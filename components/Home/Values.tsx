...
export default function Values() {
  const gradients = [
    ...
    "from-blue-800 to-yellow-700",
    "from-yellow-700 to-red-600",
    "from-red-600 via-blue-800 to-yellow-700",
  ];

  return (
    <section
      id="values"
      className="px-6 sm:px-8 lg:px-16 py-20 lg:py-32 bg-white relative overflow-hidden"
    >
      {/* Animated background */}
      <div className="absolute inset-0 opacity-20">
        <div className="absolute top-0 left-1/4 w-96 h-96 bg-red-600/10 rounded-full blur-3xl animate-pulse"></div>
        <div
          className="absolute bottom-0 right-1/4 w-96 h-96 bg-blue-800/10 rounded-full blur-3xl animate-pulse"
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center mb-16">
          ...
          <div className="h-1 w-24 bg-gradient-to-r from-red-600 to-blue-800 rounded-full mx-auto mb-6"></div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {values.map((value, index) => (
            <div key={index} className="group relative">
              <div className="absolute inset-0 bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl transform transition-all duration-500 group-hover:scale-105 group-hover:shadow-2xl"></div>
